  ...
  return (
    <div className="flex flex-col h-full rounded-2xl overflow-hidden"
      ...
      <div className="flex items-center justify-between px-4 py-3.5 shrink-0"
        style={{ borderBottom: '1px solid rgba(255,255,255,0.82)' }}>
        ...
        {TABS.map(t => (
          <button key={t.key}
            ...
            style={tab === t.key
              ...
              : { background: 'rgba(255,255,255,0.72)', color: '#52525b', border: '1px solid rgba(255,255,255,0.80)' }}>
            {t.label}
          </button>
        ))}
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-3 pb-3 space-y-1.5 min-h-0"
        style={{ scrollbarWidth: 'thin', scrollbarColor: 'rgba(255,255,255,0.84) transparent' }}>
        {loading && (
        ...
        {filtered.map(ev => {
          ...
          return (
            <div key={ev.id}
              ...
              style={{ background: 'rgba(255,255,255,0.68)', border: `1px solid rgba(${rgb},0.12)` }}>
