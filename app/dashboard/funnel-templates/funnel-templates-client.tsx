...
export function FunnelTemplatesClient({ templates, bots }: Props) {
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      ...
      {/* Bot selector */}
      <div className="rounded-2xl p-4 space-y-2" style={{ background: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.09)' }}>
        ...
        {templates.map(t => {
          ...
          return (
            <div key={t.id} className="rounded-2xl overflow-hidden transition-all"
              style={{ background: 'rgba(255,255,255,0.02)', border: wasApplied ? '1px solid rgba(52,211,153,0.3)' : '1px solid rgba(255,255,255,0.07)' }}>
