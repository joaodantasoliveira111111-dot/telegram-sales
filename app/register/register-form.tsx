...
import { Loader2, Eye, EyeOff, Check, Zap, ArrowRight } from 'lucide-react'
...
const PLANS = [
  {
    ...
    price: 'R$ 0,50',
    per: 'por venda',
    desc: 'Comece sem mensalidade. Pague apenas quando vender.',
    features: ['Sem mensalidade', 'R$ 0,50 por venda', 'Todos os recursos', 'Suporte incluso'],
    highlight: false,
  },
  {
    id: 'starter',
    ...
    features: ['R$ 97/mês fixo', 'R$ 0,35 por venda', 'Todos os recursos', 'Suporte prioritário'],
    highlight: true,
  },
  {
    id: 'pro',
    ...
    price: 'R$ 297',
    per: '/mês',
    desc: 'Alto volume. Taxa mínima por venda.',
    features: ['R$ 297/mês fixo', 'R$ 0,05 por venda', 'Todos os recursos', 'Suporte VIP'],
    highlight: false,
  },
]
...
export function RegisterForm() {
  ...
  const inputCls = "w-full rounded-xl border px-4 py-3 text-sm text-zinc-100 placeholder-zinc-600 outline-none transition-all focus:ring-2 bg-white/5"
  const inputStyle = { borderColor: 'rgba(255,255,255,0.1)' }
  const inputFocus = { '--tw-ring-color': 'rgba(139,92,246,0.3)' } as React.CSSProperties
      ...
      <div className="relative w-full max-w-4xl">
        ...
        {step === 'plan' && (
          <div className="animate-fade-up">
            <p className="text-center text-sm text-zinc-400 mb-6">Escolha seu plano para começar</p>
              ...
              {PLANS.map((plan) => (
                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-3">
                    <div>
                      <p className="font-bold text-zinc-100 text-base">{plan.name}</p>
                      <p className="text-xs text-zinc-500 mt-0.5">{plan.desc}</p>
                    </div>
                    <div
                      className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full border transition-all"
                      style={{
                        borderColor: selectedPlan === plan.id ? '#8b5cf6' : 'rgba(255,255,255,0.2)',
                        background: selectedPlan === plan.id ? '#8b5cf6' : 'transparent',
                      }}
                    >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className="space-y-1.5">
                    ...
                    <input
                      type="text"
                      value={form.cpf_cnpj}
                      onChange={(e) => field('cpf_cnpj', formatCPF(e.target.value))}
